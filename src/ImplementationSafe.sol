...
contract ImplementationSafe is NoDelegateCall {
    ...
    function delegatecallContract(address a, bytes calldata _calldata) payable external noDelegateCall returns (bytes memory) {
